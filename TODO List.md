...
- [ ] **Решить проблему разных template:** У Cydonia темплейт mistral-tekken 7 (см рядом), а Vistral - ChatMl (вроде, проверь) и надо подумать как при дообучении уже наверно как это поправить и их слить, не разрушая связей знаний RP
